...
import { generateStoryFromImage } from '@/api';
...
const Chatbox = () => {
  ...
  const handleSend = async (e) => {
    ...
    const loadingIndex = messages.length + 1; // account for async setMessages
    ...
    try {
      ...
      if (selectedModel === 'Gemini' && image) {
        ...
        response = 'Please upload an image to generate a story.';
      }
    ...
    >
      {messages.length === 0 && (
        <div className="flex flex-col items-center justify-center flex-grow">
          <h3 className="md:text-5xl text-3xl text-center font-light text-black">
